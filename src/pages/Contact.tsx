              ...
              <div className="space-y-8">
                ...
                <div className="bg-primary rounded-2xl p-8 text-primary-foreground">
                  ...
                  <div className="space-y-4">
                    <a 
                      href="https://wa.me/250780000000?text=Hi, I'm interested in your properties"
                      target="_blank"
                    ...
                    >
                      ...
                      <div>
                        <p className="font-medium">+250 780 000 000</p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:info@ckimhomes.rw" className="text-muted-foreground text-sm hover:text-secondary transition-colors">
                          info@ckimhomes.rw
                        </a>
                      </div>
                    </div>
